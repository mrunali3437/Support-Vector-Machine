...
salary_train <-  read.csv("C:/Users/abc/Desktop/Data science/Dataset/SVM & NN/SalaryData_Train.csv") #This data is used to train the Model
attach(salary_train)

salary_test <- read.csv("C:/Users/abc/Desktop/Data science/Dataset/SVM & NN/SalaryData_Test.csv") #This data is used to Test the Model
attach(salary_test)
...
#Here there are many variables that we need to convert into an Categorical Vriable. Lets Convert them
