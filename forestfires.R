...
library(e1071)  #This package is used for SVM
library(kernlab)
library(ggplot2)

forest <- read.csv("C:/Users/abc/Desktop/Data science/Dataset/SVM & NN/forestfires.csv")
summary(forest)
attach(forest)
forest1 <- forest[,1:10]
...
prop.table(table(size_category))*100
prop.table(table(train1$size_category))*100
prop.table(table(test1$size_category))*100
...
#Here the Accuracy of the Model is 75.37%
...
#Here the Accuracy of the Model is 74.67%
...
#Here the Accuracy of the Model is 62.23%
...
#Here the Accuracy of the Model is 62.98%
...
#Here the Accuracy of the Model is 75.42%
...
#Here the Accuracy of the Model is 64.03%
...
#Here the Accuracy of the Model is 70.28%

#The Laplacedot Kernel Model has the Least Training Error with a Accuracy of 75.42%
